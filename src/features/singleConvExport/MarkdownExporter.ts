...
function formatTimestamp(epochMs: number | null): string {
  // Claude parser stores ms (ISO date string parsed via Date.parse); the
  // legacy ChatGPT pipeline used seconds.  We standardised on ms — see
  // src/features/conversationApi/types.ts.
